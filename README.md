...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/requests-oauthlib-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/requests-oauthlib-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/requests-oauthlib-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/requests-oauthlib-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/requests-oauthlib-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/requests-oauthlib-feedstock/branch/master)
